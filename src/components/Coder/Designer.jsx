        ...
        <div>
            ...
            <section className="Designer-section">
                <div className="Designer-content">
                    <h1>about.</h1>
                    <p>I&aposm a product designer based in Paris, France. Well, I mean I live in aubervilliers. It&aposs technically suburb. But there is a Metro close to my appartement. So I&aposm in Paris.</p>
                    <p>Since 2015, I&aposve enjoyed turning complex problems into simple, beautiful and intuitive designs. 
