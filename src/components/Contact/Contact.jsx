          ...
          <div className="social-links">
            ...
            <div id="linkedin" className="social-btn flex-center">
              <a href="https://www.linkedin.com/in/bruno-delourme-52394a164/" target="_blank" rel="noopener noreferrer">
                ...
                <span> Linkedin / Bruno Delourme</span>
              </a>
            </div>

            <div id="github" className="social-btn flex-center">
              <a href="https://github.com/Bruno-Delourme" target="_blank" rel="noopener noreferrer">
                <svg viewBox="0 0 24 24" height="24" width="24" xmlns="http://www.w3.org/2000/svg">
                ...
                <span> Git Hub / Bruno-Delourme</span>
              </a>
            </div>
          </div>
        </div>
          ...
          >
            ...
            {isClicked && (
              <div className="overlay">
                <p className="text">Depp Fake Me</p>
              </div>
            )}
          </div>
        </div>
